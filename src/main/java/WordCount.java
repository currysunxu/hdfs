...
//        //指定我们去哪一个路径读取文件
//        FileInputFormat.addInputPath(job,new Path("/Users/ef/Documents/BI_study/bigdata/hdfs01/src/main/resources/input.txt"));
//
...
//        TextOutputFormat.setOutputPath(job,new Path("/Users/ef/Documents/BI_study/bigdata/hdfs01/test-1202"));
//        //提交job任务
...
//        //Todo local test first,then deploy hfds
////        configuration.set("mapreduce.framework.name","yarn");
////        configuration.set("yarn.resourcemanager.hostname","node01");
